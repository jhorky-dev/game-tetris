// Definir el tamaño de cada espacio de la cuadrícula
const gridSpace = 30;
...
// Definir los bordes del area del juego
...
// Función de configuración de llamada de inicio de juego
function setup() {
    createCanvas(600, 540);
    //Crear una primera pieza que caerá de la cuadrícula
...
//Funcion para dibujar la llamada repetidamente
function draw() {
    //Definir los colores usados en el juego
    const colorsDark = '#0d0d0d';
    const colorsLight = '#304550';
    const colorBackground = '#e1eeb0';

    //Establecer el color de fondo
    background(colorBackground);

    //Dibujar el panel de información derecho
    fill(25);
    noStroke();
    rect(gameEdgeRight, 0, 150, height);

    //Dibujar el panel de información izquierdo
    rect(0, 0, gameEdgeLeft, height);

    //Dibujar el rectangulo de Score
    fill(colorBackground);
    rect(450, 80, 150, 70);

    //Dibujar la siguiente pieza rectangular
    rect(460, 405, 130, 130, 5, 5);

    //Dibujar el level rectangular
    rect(460, 210, 130, 60, 5, 5);

    //Dibujar la linea rectangular
